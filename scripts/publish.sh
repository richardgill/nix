...
rsync -av --filter=':- .gitignore' --exclude='.git' --exclude='flake/modules/home-manager/dot-files/Scripts/final-cut-pro.swift' --exclude='flake/modules/home-manager/dot-files/Scripts/beeper-cli' --exclude='flake/modules/home-manager/dot-files/ai-agents/shared/skills/slack/slack-client.sh' --exclude='flake/modules/home-manager/dot-files/ai-agents/shared/skills/posthog/***' --exclude='flake/modules/system/nixos/headless/optional/tailscaled-work.nix' --exclude='out-of-store-config/services/ai-cron/***' --exclude='todo.md' "$source_dir/" .
