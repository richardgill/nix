...
rsync -av --filter=':- .gitignore' --exclude='.git' --exclude='overlay/***' --exclude='flake/modules/home-manager/dot-files/Scripts/final-cut-pro.swift' --exclude='flake/modules/home-manager/dot-files/Scripts/beeper-cli' --exclude='flake/modules/home-manager/dot-files/ai-agents/shared/skills/beeper/***' --exclude='flake/modules/home-manager/dot-files/ai-agents/shared/skills/slack/slack-client.sh' --exclude='flake/modules/home-manager/dot-files/ai-agents/shared/skills/posthog/***' --exclude='flake/modules/system/nixos/headless/optional/tailscaled-work.nix' --exclude='out-of-store-config/services/ai-cron/***' --exclude='todo.md' "$source_dir/" .

# Copy built/ separately since it's gitignored in source but tracked in public repo
rsync -av --exclude='ai-agents/*/skills/beeper/***' --exclude='ai-agents/*/skills/slack/***' --exclude='ai-agents/*/skills/posthog/***' "$source_dir/built/" ./built/
