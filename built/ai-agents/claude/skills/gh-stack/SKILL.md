...
```bash
~/Scripts/worktree-branch --no-switch --pull --binary cl --prompt-file '<prompt-file>' '<bottom>'
~/Scripts/worktree-branch --no-switch --pull --binary cl --prompt-file '<prompt-file>' '<parent>' '<child>'
```
