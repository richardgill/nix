...
~/Scripts/worktree-branch --detached --pull --cmd 'amp "fix the login bug"' fix-login

# Create worktree from remote branch
~/Scripts/worktree-branch --detached --pull --cmd 'amp "implement the feature from the PR description"' origin/feature-branch
```
