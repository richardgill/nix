...
```bash
~/Scripts/worktree-branch --no-switch --pull --binary amp --prompt-file '<prompt-file>' '<bottom>'
~/Scripts/worktree-branch --no-switch --pull --binary amp --prompt-file '<prompt-file>' '<parent>' '<child>'
```
