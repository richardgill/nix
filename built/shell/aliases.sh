...
alias aci='auto-commit --add-all'
alias acip='~/Scripts/auto-commit-push --add-all'
alias acipr='auto-commit-pr --add-all'
alias pr='quick-pr'
alias pr-ai='auto-pr'
...
alias ls="~/Scripts/ls"
alias lso="/nix/store/wkkwxc04gdw6b263l1h29pjarjnjdyb6-coreutils-9.8/bin/ls"
alias tree="ls --tree"
alias cato="/nix/store/wkkwxc04gdw6b263l1h29pjarjnjdyb6-coreutils-9.8/bin/cat"
